		...
		class RegularPassenger {
			...
			public void testEconomyFlightRegularPassenger() {
				assertAll(
						...
						() -> assertEquals("Mike",
								new ArrayList<>(
										economyFlight.getPassengersSet())
												.get(0).getName()),
						() -> assertEquals(true,
			...
			public void testEconomyFlightRegularPassengerAddedOnlyOnce(
				...
				assertAll(
						...
						() -> assertEquals(1,
								economyFlight.getPassengersSet().size()),
						() -> assertTrue(economyFlight.getPassengersSet()
								.contains(mike)),
						() -> assertTrue(new ArrayList<>(
								economyFlight.getPassengersSet()).get(0)
										.getName().equals("Mike")));
			}
		}
		...
		class RegularPassenger {
			...
			public void testBusinessFlightRegularPassenger() {
				assertAll(
						...
						() -> assertEquals(0,
								businessFlight.getPassengersSet().size()),
						() -> assertEquals(false,
		...
		class VipPassenger {
			...
			public void testBusinessFlightVipPassengerAddedOnlyOnce(
				...
				assertAll(
						...
						() -> assertEquals(1,
								businessFlight.getPassengersSet().size()),
						() -> assertTrue(businessFlight.getPassengersSet()
								.contains(james)),
						() -> assertTrue(new ArrayList<>(
								businessFlight.getPassengersSet()).get(0)
										.getName().equals("James")));
			}
		}
	}
		...
		class RegularPassenger {
			...
			public void testPremiumFlightRegularPassenger() {
				assertAll(
						...
						() -> assertEquals(0,
								premiumFlight.getPassengersSet().size()),
						() -> assertEquals(false,
		...
		class VipPassenger {
			...
			public void testPremiumFlightVipPassengerAddedOnlyOnce(
				...
				assertAll(
						...
						() -> assertEquals(1,
								premiumFlight.getPassengersSet().size()),
						() -> assertTrue(premiumFlight.getPassengersSet()
								.contains(james)),
						() -> assertTrue(new ArrayList<>(
								premiumFlight.getPassengersSet()).get(0)
										.getName().equals("James")));
			}
		}
	}
