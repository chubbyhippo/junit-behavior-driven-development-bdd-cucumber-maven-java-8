...
public class PassengerPolicy {
	...
	public void you_can_add_him_but_cannot_remove_him_from_an_economy_flight()
		...
		assertAll(
				...
				() -> assertEquals(1, economyFlight.getPassengersSet().size()),
				() -> assertTrue(
						economyFlight.getPassengersSet().contains(john)),
	...
	public void you_cannot_add_a_VIP_passenger_to_a_business_flight_more_than_once()
		...
		assertAll(
				...
				() -> assertEquals(1,
						businessFlight.getPassengersSet().size()),
				() -> assertTrue(
						businessFlight.getPassengersSet().contains(john)),
				() -> assertTrue(
						new ArrayList<>(businessFlight.getPassengersSet())
								.get(0).getName().equals("John")));
	}
	...
	public void you_cannot_add_a_VIP_passenger_to_a_premium_flight_more_than_once()
		...
		assertAll(
				...
				() -> assertEquals(1, premiumFlight.getPassengersSet().size()),
				() -> assertTrue(
						premiumFlight.getPassengersSet().contains(john)),
				() -> assertTrue(
						new ArrayList<>(premiumFlight.getPassengersSet())
								.get(0).getName().equals("John")));
	}
}
